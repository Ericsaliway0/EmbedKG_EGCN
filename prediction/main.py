...
if __name__ == "__main__":
    ...
    ##parser.add_argument('--out-feats', type=int, default=1, help='Dimension of the final layer')
    ...
    G_dgl, node_features = load_graph_data('embedding/data/merged_gene_embeddings.json')

    train_and_evaluate(args, G_dgl, node_features)


## ___KG-PE % python prediction/main.py --in-feats 128 --out-feats 128 --num-heads 4 --num-layers 2 --lr 0.01 --input-size 2 --hidden-size 16 --feat-drop 0.1 --attn-drop 0.1 --epochs 2001
## python prediction/main.py --in-feats 128 --out-feats 128 --num-heads 4 --num-layers 2 --lr 0.01 --input-size 2 --hidden-size 16 --feat-drop 0.1 --attn-drop 0.1 --epochs 2001
